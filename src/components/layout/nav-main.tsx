...
export function NavMain() {
  ...
  const userRole: UserRole =
    userMetadata.role === "OWNER" ? "OWNER" : "MANAGER";
  ...
  return (
    <div className="space-y-3 px-3 py-2 select-none">
      ...
      <Link
        href="/app"
        className={`flex items-center gap-3 w-full p-2.5 rounded-2xl border transition-all duration-200 ${
          isDashboardActive
        ...
        <div className="flex flex-col text-left min-w-0">
          ...
          <span
            className={`text-[10px] mt-1 font-normal truncate ${
              isDashboardActive ? "text-sky-100" : "text-muted-foreground"
            }`}
          >
                  ...
                  return (
                    ...
                    >
                      ...
                      {item.badge && (
                        <Badge
                          variant="outline"
                          className={`ml-auto text-[9px] px-1.5 py-0 font-medium ${
                            isActive

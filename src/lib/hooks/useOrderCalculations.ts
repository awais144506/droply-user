...
import { OrderFormValues } from "@/features/orders/schema/create-order-schema";
...
export const useOrderCalculations = (branchId: string, previousKhataBalance: number = 0) => {
    ...
    const totalDue = (grossTotal - globalDiscount) + previousKhataBalance + totalSecurityDeposit;
